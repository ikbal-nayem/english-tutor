...
import { Clock, MessageSquare, AlertTriangle, CheckCircle, Lightbulb, Star, BarChart } from "lucide-react"
                      ...
                      {sentences
                        ...
                        .map((mistake, i) => (
                          <li key={i} className="text-xs text-purple-800 flex items-start">
                            <span className="inline-block w-4 h-4 bg-purple-200 rounded-full text-purple-600 flex items-center justify-center text-xs mr-1 mt-0.5">
                              {i + 1}
                            </span>
                            {mistake}
                          </li>
